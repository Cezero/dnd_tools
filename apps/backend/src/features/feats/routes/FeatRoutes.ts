 ...
 */
FeatRouter.get('/', GetFeats as RequestHandler);
 ...
 *         description: Server error.
 */
FeatRouter.get('/:id', GetFeatById as unknown as RequestHandler);
 ...
 *         description: Server error.
 */
FeatRouter.post('/', RequireAdmin as RequestHandler, CreateFeat as RequestHandler);
 ...
 *         description: Server error.
 */
FeatRouter.put('/:id', RequireAdmin as RequestHandler, UpdateFeat as unknown as RequestHandler);
 ...
 *         description: Server error.
 */
FeatRouter.delete('/:id', RequireAdmin as RequestHandler, DeleteFeat as unknown as RequestHandler); 