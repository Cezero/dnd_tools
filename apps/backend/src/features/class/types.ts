...
export interface ClassService {
    ...
    getClassById: (query: ClassIdParamRequest, characterFeatureChoices?: Array<{ featureId: number; featureEntityId: number; appliesToId: number | null; appliesToSubId: number | null }>) => Promise<DnDClass | null>;
