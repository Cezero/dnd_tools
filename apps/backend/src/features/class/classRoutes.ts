 ...
 */
ClassRouter.get('/', validateRequest({ query: ClassQuerySchema }) as RequestHandler, GetClasses as RequestHandler);
 ...
 *         description: Server error.
 */
ClassRouter.get('/:id', validateRequest({ params: ClassIdParamSchema }) as RequestHandler, GetClassById as unknown as RequestHandler);
 ...
 *         description: Server error.
 */
ClassRouter.post('/', requireAdmin as RequestHandler, validateRequest({ body: CreateClassSchema }) as RequestHandler, CreateClass as RequestHandler);
 ...
 *         description: Server error.
 */
ClassRouter.put('/:id', requireAdmin as RequestHandler, validateRequest({ params: ClassIdParamSchema, body: UpdateClassSchema }) as RequestHandler, UpdateClass as unknown as RequestHandler);
 ...
 *         description: Server error.
 */
ClassRouter.delete('/:id', requireAdmin as RequestHandler, validateRequest({ params: ClassIdParamSchema }) as RequestHandler, DeleteClass as unknown as RequestHandler); 