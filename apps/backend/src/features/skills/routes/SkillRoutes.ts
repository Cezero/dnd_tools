 ...
 */
SkillRouter.get('/', GetSkills as RequestHandler);
 ...
 *         description: Server error.
 */
SkillRouter.get('/:id', GetSkillById as unknown as RequestHandler);
 ...
 *         description: Server error.
 */
SkillRouter.post('/', RequireAdmin as RequestHandler, CreateSkill as RequestHandler);
 ...
 *         description: Server error.
 */
SkillRouter.put('/:id', RequireAdmin as RequestHandler, UpdateSkill as unknown as RequestHandler);
 ...
 *         description: Server error.
 */
SkillRouter.delete('/:id', RequireAdmin as RequestHandler, DeleteSkill as unknown as RequestHandler); 