...
} from '../controllers/ReferenceTableController.js';
 ...
 */
ReferenceTableRouter.get('/', GetReferenceTables as RequestHandler);
 ...
 *         description: Server error.
 */
ReferenceTableRouter.get('/:identifier', GetReferenceTable as unknown as RequestHandler);
 ...
 *         description: Server error.
 */
ReferenceTableRouter.post('/', RequireAdmin as RequestHandler, CreateReferenceTable as RequestHandler);
 ...
 *         description: Server error.
 */
ReferenceTableRouter.put('/:id', RequireAdmin as RequestHandler, UpdateReferenceTable as unknown as RequestHandler);
 ...
 *         description: Server error.
 */
ReferenceTableRouter.delete('/:id', RequireAdmin as RequestHandler, DeleteReferenceTable as unknown as RequestHandler); 