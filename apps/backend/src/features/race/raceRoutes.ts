 ...
 */
RaceRouter.get('/', validateRequest({ query: RaceQuerySchema }) as RequestHandler, GetRaces as RequestHandler);
 ...
 *         description: Server error.
 */
RaceRouter.get('/traits/:slug', validateRequest({ params: RaceTraitSlugParamSchema }) as RequestHandler, GetRaceTraitBySlug as unknown as RequestHandler);
 ...
 *         description: Server error.
 */
RaceRouter.post('/traits', requireAdmin as RequestHandler, validateRequest({ body: CreateRaceTraitSchema }) as RequestHandler, CreateRaceTrait as RequestHandler);
 ...
 *         description: Server error.
 */
RaceRouter.put('/traits/:slug', requireAdmin as RequestHandler, validateRequest({ params: RaceTraitSlugParamSchema, body: UpdateRaceTraitSchema }) as RequestHandler, UpdateRaceTrait as unknown as RequestHandler);
 ...
 *         description: Server error.
 */
RaceRouter.delete('/traits/:slug', requireAdmin as RequestHandler, validateRequest({ params: RaceTraitSlugParamSchema }) as RequestHandler, DeleteRaceTrait as unknown as RequestHandler);
 ...
 *         description: Server error.
 */
RaceRouter.get('/:id', validateRequest({ params: RaceIdParamSchema }) as RequestHandler, GetRaceById as unknown as RequestHandler);
 ...
 *         description: Server error.
 */
RaceRouter.post('/', requireAdmin as RequestHandler, validateRequest({ body: CreateRaceSchema }) as RequestHandler, CreateRace as RequestHandler);
 ...
 *         description: Server error.
 */
RaceRouter.put('/:id', requireAdmin as RequestHandler, validateRequest({ params: RaceIdParamSchema, body: UpdateRaceSchema }) as RequestHandler, UpdateRace as unknown as RequestHandler);
 ...
 *         description: Server error.
 */
RaceRouter.delete('/:id', requireAdmin as RequestHandler, validateRequest({ params: RaceIdParamSchema }) as RequestHandler, DeleteRace as unknown as RequestHandler); 