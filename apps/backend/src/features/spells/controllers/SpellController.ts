...
export async function GetSpells(req: Request<{}, {}, {}, SpellQueryParams>, res: Response) {
...
export async function UpdateSpell(req: Request<{ id: string }, {}, UpdateSpellRequest>, res: Response) {
    const spellId = parseInt(req.params.id);
    const {
