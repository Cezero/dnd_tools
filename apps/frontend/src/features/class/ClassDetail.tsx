            ...
            <div className={outerContainerClasses}>
                <div className={innerCellContentClasses}>
                    ...
                    <div className="mt-4 text-right">
                        ...
                        {isAdmin && (
                            <Link to={`/classes/${id}/edit`} state={{ fromListParams: fromListParams }} className="ml-4 inline-block px-4 py-2 bg-blue-600 rounded hover:bg-blue-700 border dark:border-gray-500">Edit Class</Link>
                        )}
                    </div>
                </div>
            </div>
