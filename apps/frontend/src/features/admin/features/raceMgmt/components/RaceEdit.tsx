...
import { SIZE_LIST, SIZE_MAP, LANGUAGE_LIST, LANGUAGE_MAP, EDITION_LIST, EDITION_MAP } from '@shared/static-data/CommonData';
import { GetBaseClassesByEdition, CLASS_MAP } from '@shared/static-data/ClassData';
import { ABILITY_LIST } from '@shared/static-data/AbilityData';
