...
import { FEAT_PREREQUISITE_TYPES, FEAT_PREREQUISITE_TYPE_LIST } from '@shared/static-data/FeatData';
/**
...
export function FeatPrereqAssoc({ isOpen, onClose, onSave, initialSelectedPrereqIds = [], featId }) {
    ...
    const filterOptions = useMemo(() => ({
        prereq_id: { component: TextInput, props: { type: 'text', placeholder: 'Filter by ID...' } },
        prereq_type: { component: TextInput, props: { type: 'text', placeholder: 'Filter by type...' } },
    }), []);
