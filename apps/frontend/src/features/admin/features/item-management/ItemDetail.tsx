...
export function ItemDetail(): React.JSX.Element {
    ...
    const outerContainerClasses = "max-w-4xl mx-auto bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden";
    const innerCellContentClasses = "p-6";
                ...
                <div className={innerCellContentClasses}>
                    ...
                    <div className="mb-2">
                        <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-2"><div className="font-semibold">Cost:</div> {formatCostAsCurrency(item.cost)}</div>
                            <div className="flex items-center gap-2"><div className="font-semibold">Weight:</div> {item.weight !== null ? `${item.weight}` + (item.weight === 1 ? ' lb.' : ' lbs.') : '-'}</div>
