...
import { Dialog, Transition, DialogPanel, DialogTitle, Listbox, ListboxButton, ListboxOptions, ListboxOption } from '@headlessui/react';
...
export function FeatBenefitEdit({ isOpen, onClose, onSave, initialBenefitData }) {
