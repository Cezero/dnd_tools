...
// Check if all entities in a feature are valid
export function validateFeatureEntities(
...
// Check if a feature has at least one component
export function hasFeatureComponents(
    entities: FeatureEntity[]
): boolean {
...
export function validateFeatureLevel(level: number): boolean {
