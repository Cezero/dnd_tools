...
export const SkillSchema = z.object({
    ...
    retryTypeId: z.number().int().min(0, 'Retry type ID must be 0 or higher').nullable(),
    ...
    restrictionNotes: z.string().max(10000, 'Restriction notes must be less than 10000 characters').nullable(),
});
