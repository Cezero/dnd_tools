import type { ClassMap, NameToIdMap, SelectOption, SpellTable, BaseMap, CoreComponent } from './types';
...
export const OVERRIDE_TYPE_SELECT_LIST = NameSelectOptionList(OVERRIDE_TYPE_LIST);
...
export const ENTITY_OVERRIDE_TYPE_SELECT_LIST = NameSelectOptionList(ENTITY_OVERRIDE_TYPE_LIST);
