...
- **Stacking**: Does not stack with other armor bonuses
- **Touch Attacks**: Does not apply (except force effects)
...
- **Stacking**: Always stacks (unless same source)
...
- **Stacking**: Does not stack with other competence bonuses
...
- **Stacking**: Does not stack with other deflection bonuses
- **Touch Attacks**: Applies
...
- **Stacking**: Always stacks with all bonuses
- **Touch Attacks**: Applies
- **Source**: Never from spells or magic items

### Enhancement Bonus
An enhancement bonus represents an increase in the sturdiness and/or effectiveness of armor or natural armor, or the effectiveness of a weapon, or a general bonus to an ability score. Multiple enhancement bonuses on the same object (in the case of armor and weapons), creature (in the case of natural armor), or ability score do not stack. Only the highest enhancement bonus applies. Since enhancement bonuses to armor or natural armor effectively increase the armor or natural armor's bonus to AC, they don't apply against touch attacks.
- **Stacking**: Does not stack with other enhancement bonuses to same target
- **Touch Attacks**: Does not apply (for AC bonuses)
...
- **Stacking**: Does not stack with other insight bonuses
...
- **Stacking**: Does not stack with other luck bonuses
...
- **Stacking**: Does not stack with other morale bonuses
- **Restrictions**: No effect on nonintelligent creatures
...
- **Stacking**: Does not stack with other natural armor bonuses
- **Touch Attacks**: Does not apply
...
- **Stacking**: Does not stack with other profane bonuses
...
- **Stacking**: Typically does not stack with other racial bonuses
...
- **Stacking**: Does not stack with other resistance bonuses
...
- **Stacking**: Does not stack with other sacred bonuses
...
- **Stacking**: Does not stack with other shield bonuses
- **Touch Attacks**: Does not apply
...
- **Stacking**: Does not stack with other size bonuses of the same type
