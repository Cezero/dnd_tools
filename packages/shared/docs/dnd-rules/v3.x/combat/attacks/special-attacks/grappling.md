...
> **Note**: Use this number **in place of** the normal size modifier you use when making an attack roll.
...
### Cast a Spell
You can attempt to **cast a spell** while grappling or even while pinned (see below), provided:
- Its casting time is **no more than 1 standard action**
- It has **no somatic component**
- You have in hand any **material components or focuses** you might need
...
- **1d3 points** for Medium attackers
- **1d2 points** for Small attackers 
- Plus **Strength modifiers**
...
### Restrictions While Pinning
You **can't** do the following while you are pinning an opponent:
- **Draw or use a weapon** (against the pinned character or any other character)
- **Escape another's grapple**
- **Retrieve a spell component**
- **Pin another character**
- **Break another's pin**
...
- The target **doesn't get an attack of opportunity** against you
- Your **grab automatically succeeds**
...
### Size Considerations
- Creatures that are **one or more size categories smaller** than you count for **half**
- Creatures that are **one size category larger** than you count **double**
- Creatures **two or more size categories larger** count **quadruple**
