...
1. **Specify the action** you will take
2. **Specify the conditions** under which you will take it
3. Any time before your next action, you may take the readied action **in response to that condition**
...
> **Movement**: You can take a **5-foot step** as part of your readied action, but only if you don't otherwise move any distance during the round.
...
You may ready a **counterspell** against a spellcaster (often with the trigger "if she starts casting a spell"). In this case:

1. When the spellcaster starts a spell, you get a chance to **identify it** with a Spellcraft check (DC 15 + spell level)
2. If you do, and if you can cast that same spell (are able to cast it and have it prepared, if you prepare spells), you can cast the spell as a counterspell and **automatically ruin** the other spellcaster's spell
3. **Counterspelling works** even if one spell is divine and the other arcane

> **Alternative**: A spellcaster can use **dispel magic** to counterspell another spellcaster, but it doesn't always work.
