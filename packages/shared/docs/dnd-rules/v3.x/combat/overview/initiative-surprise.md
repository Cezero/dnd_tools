...
```
Initiative Check = 1d20 + Dexterity modifier
```

### Resolving Ties

If two or more combatants have the same initiative check result:
1. The combatants who are tied act in order of **total initiative modifier** (highest first)
2. If there is still a tie, the tied characters should **roll again** to determine which one of them goes before the other
