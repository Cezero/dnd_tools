...
import { DEFAULT_COLUMNS, COLUMN_DEFINITIONS } from './config/spellConfig';
...
function SpellList() {
    ...
    const renderSpellCell = (spell, columnId) => {
        switch (columnId) {
            ...
            case 'components':
                return LookupService.getComponentNames(spell.components);
            case 'source':
            ...
            props: {
                children: (
                    <>
                        ...
                        {LookupService.getAll('schools').map(school => (
            ...
            props: {
                children: (
                    <>
                        ...
                        {LookupService.getAll('classes')
                            .filter(dndClass => dndClass.caster)
                            .map(dndClass => (
