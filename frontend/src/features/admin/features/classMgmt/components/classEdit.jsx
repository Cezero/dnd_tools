                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    <div className="grid grid-cols-2 gap-2">
                        <div className="flex items-center gap-2">
                            <label htmlFor="class_name" className="block font-medium">Class Name:</label>
                            <input type="text" id="class_name" name="class_name" value={cls.class_name || ''} onChange={handleChange} className="mt-1 block p-2 border rounded dark:bg-gray-700 dark:border-gray-600" />
                        </div>
                        <div className="flex items-center gap-2">
                            <label htmlFor="class_abbr" className="block font-medium">Abbreviation:</label>
                            <input type="text" id="class_abbr" name="class_abbr" value={cls.class_abbr || ''} onChange={handleChange} className="mt-1 block p-2 border rounded dark:bg-gray-700 dark:border-gray-600" />
                        </div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2 justify-end pb-1">
                            <label htmlFor="is_prestige_class" className="ml-2 font-medium">Prestige Class</label>
                        ...
                        <div className="flex items-center gap-2 justify-end pb-1">
                            <label htmlFor="caster" className="ml-2 font-medium">Caster</label>
