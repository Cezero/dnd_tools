...
import { FEAT_BENEFIT_TYPES, FEAT_BENEFIT_TYPE_LIST } from 'shared-data/src/featData';
 ...
 */
export default function FeatBenefitAssoc({ isOpen, onClose, onSave, initialSelectedBenefitIds = [], featId }) {
    ...
    const filterOptions = useMemo(() => ({
        benefit_id: { component: Input, props: { type: 'text', placeholder: 'Filter by ID...' } },
        benefit_type: { component: Input, props: { type: 'text', placeholder: 'Filter by type...' } },
    }), []);
