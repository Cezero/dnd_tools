...
import { fetchFeatById } from '@/features/admin/features/featMgmt/services/featService';
import { FEAT_TYPES, FEAT_BENEFIT_TYPES, FEAT_PREREQUISITE_TYPES } from 'shared-data/src/featData';

export default function FeatDetail() {
    const { id } = useParams();
